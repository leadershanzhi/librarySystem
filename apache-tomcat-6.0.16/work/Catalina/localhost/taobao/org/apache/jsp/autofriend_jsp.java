...
public final class autofriend_jsp extends org.apache.jasper.runtime.HttpJspBase
...
List<User> listu=f.getListAutoFriend(uu.getUid());
      ...
      out.write(" }\r\n");
      out.write("}\r\n");
      out.write("function receive(i){\r\n");
      out.write("\tvar x=confirm(\"您确定要接受请求加此人为好友吗?\");\r\n");
      out.write("\tif(x==true){\r\n");
      out.write("\t\tvar url=\"SerHandleFriend?tag=rece&frid=\"+i;\r\n");
    ...
    for(int i=0;i<listu.size();i++){
      ...
      out.write("<div>\r\n");
      out.write("   <br>\r\n");
      out.write("  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color=\"#0099CC\" size=\"+1\" face=\"隶书\">动态请求-----<a href=\"SerHandleMain\">返回</a></font>\r\n");
      out.write(" <ul>\r\n");
      out.write("   ");
} 
      out.write("\r\n");
      out.write("  <li><span>&nbsp;&nbsp;<a href=\"javascript:void(0)\" onclick=\"receive(");
      out.print(u.getUid() );
      out.write(")\"><font size=\"-1\" face=\"幼圆\">接受请求</font></a></span><a href=\"javacript:void(0)\">");
