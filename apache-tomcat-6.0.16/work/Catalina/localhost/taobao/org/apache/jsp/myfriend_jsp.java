...
public final class myfriend_jsp extends org.apache.jasper.runtime.HttpJspBase
...
List<User> listu=f.getListMyFriend(uu.getUid());
      ...
      out.write("\tvar x=confirm(\"您确定要添加此次人为好友吗?\");\r\n");
      out.write("\tif(x==true){\r\n");
    ...
    for(int i=0;i<listu.size();i++){
      ...
      out.write("<div>\r\n");
      out.write("   <br>\r\n");
      out.write("  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color=\"#0099CC\" size=\"+1\" face=\"隶书\">我的好友-----<a href=\"SerHandleMain\">返回</a></font>\r\n");
      out.write(" <ul>\r\n");
      out.write("   ");
} 
      out.write("\r\n");
      ...
      out.write("<a href=\"javascript:void(0)\" onclick=openDialog(\"cha.jsp?frid=");
      out.print(u.getUid() );
      out.write("\")> <font size=\"-1\">查看</font></a></span><a href=\"javacript:void(0)\">");
