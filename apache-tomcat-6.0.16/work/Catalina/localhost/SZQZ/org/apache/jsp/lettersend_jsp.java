...
public final class lettersend_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\">\r\n");
      out.write("    \r\n");
      out.write("    <title>My JSP 'lettersend.jsp' starting page</title>\r\n");
      out.write("    \r\n");
      ...
      out.write("       var con=confirm(\"您确定要删除这些信息吗？\");\r\n");
      ...
      out.write("\t\t\t  }      \r\n");
      out.write("\t\t   }\r\n");
      out.write("\t\t   sendRequest(\"SerShowSend?tag=del&str=\"+str);\r\n");
      out.write("\t   }\r\n");
      out.write("       \r\n");
      out.write("   }\r\n");
      out.write("   \r\n");
      ...
      out.write("\t\t\t\tvar url=\"SerShowSend?tag=tt&p=\"+x;\r\n");
      ...
      out.write("      <tr>\r\n");
      out.write("\t    <td width=\"22%\"><div id=\"message\"></div></td>\r\n");
      out.write("        <td width=\"26%\"><a href=\"javascript:void(0)\" class=\"STYLE3\" onclick=\"del()\">点击删除选中</a></td>\r\n");
      out.write("        <td width=\"12%\"><a href=\"SerShowSend?p=before\" class=\"STYLE3\">上一页</a></td>\r\n");
      out.write("        <td width=\"9%\"><a href=\"SerShowSend?p=last\" class=\"STYLE3\">下一页</a></td>\r\n");
      ...
      out.write("        <td width=\"25%\"><span class=\"STYLE3\">收件人</span></td>\r\n");
	  ...
	  List<Map<String, Object>> list=(List<Map<String, Object>>)p.getResult();
	    ...
	    for(int i=0;i<list.size();i++){
	    	...
	    	l5=map.get("LETTERCONTENT").toString().substring(0,5);
      ...
      out.print(l3 );
      out.write("）</span></td>\r\n");
      out.write("        <td width=\"13%\" class=\"STYLE5\"><a href=\"lettercha1.jsp?letterid=");
      out.print(l1 );
      out.write('"');
      out.write('>');
      out.print(l7 );
