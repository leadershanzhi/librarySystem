  ...
  <tr>
	...
	<tr>
      ...
      <tr>
        ...
        <td width="20%" ><s:textfield  size="20" name="re.birth"  style="height:18px"  id="time" onClick="WdatePicker()"/></td>
      </tr>
      <tr>
        <td class="STYLE2" align="center" >邮箱：</td>
        <td><input type="text" style="height:18px" name="re.mail" size="17"/></td>
        <td class="STYLE2" align="center">系别：</td>
        <td>
             <select  style="width:155px" name="re.sdept">
