...
<script>
  	...
  	function check(){
    	...
    	if(total<=1){
  			window.location.href="rightsearchlend.jsp";
  		}
...
<body bgcolor="00ffff" onload="check()">
    <br/> <br/> <br/>
    <div align="center"><span class="STYLE3">该用户有欠款信息,须办理还款业务！</span></div>
	<div><hr  width="40%" align="center"/></div>
	<div align="center"><span class="STYLE1">该页面会在<span id="n">4</span>秒后跳转到借书页面</span></div>
</body>
