...
<script>
  	...
  	function check(){
    	...
    	if(total<=1){
  			window.location.href="searchselfLiuHuiAction.action";
  		}
...
<body bgcolor="00ffff" onload="check()">
    <br/> <br/> <br/>
    <div align="center"><span class="STYLE3">留言成功！</span></div>
	<div><hr  width="40%" align="center"/></div>
	<div align="center"><span class="STYLE1">该页面会在<span id="n">1</span>秒后跳转到首页面</span></div>
</body>
